                    ...
                    <div class="row g-4 align-items-center">
                        <div class="col-lg-7 animated fadeInLeft">
                            <div class="text-sm-center text-md-start">
                                ...
                                <div class="d-flex justify-content-center justify-content-md-start flex-shrink-0 mb-5" style="margin-top: 300px;">
                                    <!-- <a class="btn btn-light rounded-pill py-3 px-4 px-md-5 me-2" href="#"><i class="fas fa-play-circle me-2"></i> Watch Video</a> -->
                                    <a class="btn btn-dark rounded-pill py-3 px-4 px-md-5 ms-2 mt-5" href="{{$banner->enlace_boton}}">{{$banner->texto_boton}}</a>
                                </div>
                                @endif
                            </div>
                        </div>
        ...
        <div class="container py-5">
            <div class="row g-5 align-items-center">
                ...
                <div class="col-xl-6 wow fadeInRight" data-wow-delay="0.4s">
                    <img src="img/preguntas-frecuentes.png" class="img-fluid w-100" alt="">
                </div>
            </div>
        </div>
    </div>
