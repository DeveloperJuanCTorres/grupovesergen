                ...
                <div class="col-lg-4 text-center text-lg-end">
                    <div class="d-flex justify-content-end">
                        <div class="d-flex border-end border-primary pe-3">
                            <a class="btn p-0 text-primary me-3" href="{{$business->link_facebook}}"><i class="fab fa-facebook-f"></i></a>
                            <a class="btn p-0 text-primary me-3" href="{{$business->link_youtube}}"><i class="fab fa-youtube"></i></a>
                            <a class="btn p-0 text-primary me-3" href="{{$business->link_instagram}}"><i class="fab fa-instagram"></i></a>
                            <a class="btn p-0 text-primary me-0" href="{{$business->link_linkedin}}"><i class="fab fa-linkedin-in"></i></a>
                        </div>
                        @auth
